...
namespace LudusGestao.Infrastructure.Migrations
{
    ...
    [Migration("20250704191653_RemoveLabelFromEntities")]
    partial class RemoveLabelFromEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LudusGestao.Domain.Entities.Local", b =>
                {
                    ...
                    b.Property<List<string>>("Comodidades")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("LudusGestao.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<List<int>>("PermissoesCustomizadas")
                        .IsRequired()
                        .HasColumnType("integer[]");
